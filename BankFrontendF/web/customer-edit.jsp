    ...
    <body>
        ...
        <form action="FrontController" method="POST">
            <table border='1'>
                ...
                <tr><td>Postal Code:</td><td><input type="text" name="customerPostalCode" value="${customer.postalCode}" /></td></tr>
                <tr><td>Post District:</td><td><input type="text" name="customerPostalDistrict" value="${customer.postalDistrict}" /></td></tr>
